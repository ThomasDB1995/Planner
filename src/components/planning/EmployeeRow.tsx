...
export function EmployeeRow({
  ...
  return (
    <div className="group relative grid min-w-[calc(116px+7*(100vw-152px))] grid-cols-[116px_repeat(7,minmax(220px,calc(100vw-152px)))] items-stretch border-b border-slate-300/60 after:pointer-events-none after:absolute after:bottom-0 after:inset-x-0 after:z-20 after:h-px after:bg-slate-950/25 after:content-[''] last:border-b-0 last:after:hidden sm:min-w-[920px] sm:grid-cols-[144px_repeat(7,minmax(110px,1fr))] lg:min-w-[1040px] lg:grid-cols-[156px_repeat(7,minmax(126px,1fr))]">
      <div
